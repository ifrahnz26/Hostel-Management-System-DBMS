...
public class userlogin extends HttpServlet {
            ...
            try {
                if (email != null) {
                    ...
                    if (rs.next()) {
                        ...
                        userId = rs.getString("UserID"); // Assuming 'userId' is a column in the 'User' table

                        // Create a new session and store user information
                        HttpSession hs = request.getSession();
                        hs.setAttribute("name", name);
                        hs.setAttribute("email", emailid);
                        hs.setAttribute("UserID", userId); // Store userId in session
    ...
    public String getServletInfo() {
        return "Login Servlet for Hostel Management System";
    }
}
